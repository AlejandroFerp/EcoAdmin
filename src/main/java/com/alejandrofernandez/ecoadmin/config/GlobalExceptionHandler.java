 ...
 */
@RestControllerAdvice(basePackages = "com.alejandrofernandez.ecoadmin.controladores")
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.alejandrofernandez.ecoadmin.excepciones.TransicionEstadoInvalidaException.class)
    public ResponseEntity<Map<String, Object>> handleTransicionInvalida(
            com.alejandrofernandez.ecoadmin.excepciones.TransicionEstadoInvalidaException ex) {
