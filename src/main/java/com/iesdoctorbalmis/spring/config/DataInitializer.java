...
public class DataInitializer implements ApplicationRunner {
    ...
    private void seedDatos() {
        ...
        Usuario gestor1 = usuarioRepository.save(new Usuario("Laura Martínez", "laura.martinez@ecoadmin.com", pw, Rol.GESTOR));
        Usuario gestor2 = usuarioRepository.save(new Usuario("Carlos Ruiz", "carlos.ruiz@ecoadmin.com", pw, Rol.GESTOR));
        Usuario prod1 = usuarioRepository.save(new Usuario("Ana García", "ana.garcia@ecoadmin.com", pw, Rol.PRODUCTOR));
        Usuario prod2 = usuarioRepository.save(new Usuario("Miguel Torres", "miguel.torres@ecoadmin.com", pw, Rol.PRODUCTOR));
        Usuario prod3 = usuarioRepository.save(new Usuario("Elena Sánchez", "elena.sanchez@ecoadmin.com", pw, Rol.PRODUCTOR));
        Usuario prod4 = usuarioRepository.save(new Usuario("Javier López", "javier.lopez@ecoadmin.com", pw, Rol.PRODUCTOR));
        Usuario trans1 = usuarioRepository.save(new Usuario("Pedro Navarro", "pedro.navarro@ecoadmin.com", pw, Rol.TRANSPORTISTA));
        Usuario trans2 = usuarioRepository.save(new Usuario("Rosa Fernández", "rosa.fernandez@ecoadmin.com", pw, Rol.TRANSPORTISTA));
        Usuario trans3 = usuarioRepository.save(new Usuario("David Herrero", "david.herrero@ecoadmin.com", pw, Rol.TRANSPORTISTA));

        // == 2. DIRECCIONES (16) ==
        Direccion d1 = new Direccion("Av. de la Constitución, 10", "Alicante", "03001", "Alicante", "España");
        d1.setNombre("Oficina Central Alicante"); d1.setLatitud(38.3452); d1.setLongitud(-0.481);
        d1 = direccionRepository.save(d1);

        Direccion d2 = new Direccion("C/ San Vicente, 45", "Valencia", "46002", "Valencia", "España");
        d2.setNombre("Sede Valencia Centro"); d2.setLatitud(39.4699); d2.setLongitud(-0.3763);
        d2 = direccionRepository.save(d2);

        Direccion d3 = new Direccion("Pol. Ind. Agua Amarga, Parcela 7", "Alicante", "03114", "Alicante", "España");
        d3.setNombre("Planta Tratamiento Alicante"); d3.setLatitud(38.326); d3.setLongitud(-0.495);
        d3 = direccionRepository.save(d3);

        Direccion d4 = new Direccion("Av. del Mediterráneo, 120", "Benidorm", "03501", "Alicante", "España");
        d4.setNombre("Hotel Costa Blanca"); d4.setLatitud(38.5411); d4.setLongitud(-0.1225);
        d4 = direccionRepository.save(d4);

        Direccion d5 = new Direccion("C/ Mayor, 22", "Elche", "03201", "Alicante", "España");
        d5.setNombre("Fábrica Calzado Elche"); d5.setLatitud(38.2669); d5.setLongitud(-0.6983);
        d5 = direccionRepository.save(d5);

        Direccion d6 = new Direccion("Pol. Ind. Torrellano, Nave 15", "Elche", "03320", "Alicante", "España");
        d6.setNombre("Centro Logístico Torrellano"); d6.setLatitud(38.285); d6.setLongitud(-0.575);
        d6 = direccionRepository.save(d6);

        Direccion d7 = new Direccion("Av. de Denia, 78", "Jávea", "03730", "Alicante", "España");
        d7.setNombre("Puerto Deportivo Jávea"); d7.setLatitud(38.7833); d7.setLongitud(0.1667);
        d7 = direccionRepository.save(d7);

        Direccion d8 = new Direccion("C/ Colom, 5", "Alcoy", "03801", "Alicante", "España");
        d8.setNombre("Textil Serpis S.L."); d8.setLatitud(38.6985); d8.setLongitud(-0.4737);
        d8 = direccionRepository.save(d8);

        Direccion d9 = new Direccion("Pol. Ind. Las Atalayas, Calle B, 3", "Alicante", "03114", "Alicante", "España");
        d9.setNombre("Gestor Residuos Levante"); d9.setLatitud(38.335); d9.setLongitud(-0.51);
        d9 = direccionRepository.save(d9);

        Direccion d10 = new Direccion("Av. Juan Carlos I, 50", "Murcia", "30008", "Murcia", "España");
        d10.setNombre("Planta Reciclaje Murcia"); d10.setLatitud(37.9922); d10.setLongitud(-1.1307);
        d10 = direccionRepository.save(d10);

        Direccion d11 = new Direccion("C/ Corredera, 12", "Orihuela", "03300", "Alicante", "España");
        d11.setNombre("Agroalimentaria Vega Baja"); d11.setLatitud(38.0847); d11.setLongitud(-0.9441);
        d11 = direccionRepository.save(d11);

        Direccion d12 = new Direccion("Pol. Ind. Fuente del Jarro, 22", "Paterna", "46988", "Valencia", "España");
        d12.setNombre("Reciclados Valencia Norte"); d12.setLatitud(39.505); d12.setLongitud(-0.435);
        d12 = direccionRepository.save(d12);

        Direccion d13 = new Direccion("Carretera de Castalla km 3", "Ibi", "03440", "Alicante", "España");
        d13.setNombre("Juguetes Mediterráneo S.A."); d13.setLatitud(38.6268); d13.setLongitud(-0.5683);
        d13 = direccionRepository.save(d13);

        Direccion d14 = new Direccion("C/ del Mar, 33", "Dénia", "03700", "Alicante", "España");
        d14.setNombre("Conservas Marina Dénia"); d14.setLatitud(38.8406); d14.setLongitud(0.1056);
        d14 = direccionRepository.save(d14);

        Direccion d15 = new Direccion("Av. Oscar Esplá, 30", "Alicante", "03003", "Alicante", "España");
        d15.setNombre("Clínica Salud Alicante"); d15.setLatitud(38.3436); d15.setLongitud(-0.4907);
        d15 = direccionRepository.save(d15);

        Direccion d16 = new Direccion("Pol. Ind. El Príncipe, Nave 8", "San Javier", "30730", "Murcia", "España");
        d16.setNombre("Transportes Mar Menor"); d16.setLatitud(37.805); d16.setLongitud(-0.837);
        d16 = direccionRepository.save(d16);

        // == 3. CENTROS (13) ==
        Centro cp1 = new Centro(prod1, "Hotel Costa Blanca", "PRODUCTOR", d4);
        cp1.setNima("2800000001"); cp1.setTelefono("965851234"); cp1.setEmail("hotel@costabl.com"); cp1.setNombreContacto("Ana García");
        cp1 = centroRepository.save(cp1);

        Centro cp2 = new Centro(prod1, "Fábrica Calzado Elche", "PRODUCTOR", d5);
        cp2.setNima("2800000002"); cp2.setTelefono("966611234"); cp2.setEmail("fabrica@calzadoelche.com"); cp2.setNombreContacto("Ana García");
        cp2 = centroRepository.save(cp2);

        Centro cp3 = new Centro(prod2, "Textil Serpis S.L.", "PRODUCTOR", d8);
        cp3.setNima("2800000003"); cp3.setTelefono("965541234"); cp3.setEmail("info@textilserpis.com"); cp3.setNombreContacto("Miguel Torres");
        cp3 = centroRepository.save(cp3);

        Centro cp4 = new Centro(prod3, "Conservas Marina Dénia", "PRODUCTOR", d14);
        cp4.setNima("2800000004"); cp4.setTelefono("965781234"); cp4.setEmail("info@conservasmarina.com"); cp4.setNombreContacto("Elena Sánchez");
        cp4 = centroRepository.save(cp4);

        Centro cp5 = new Centro(prod3, "Clínica Salud Alicante", "PRODUCTOR", d15);
        cp5.setNima("2800000005"); cp5.setTelefono("965201234"); cp5.setEmail("residuos@clinicasalud.com"); cp5.setNombreContacto("Elena Sánchez");
        cp5 = centroRepository.save(cp5);

        Centro cp6 = new Centro(prod4, "Juguetes Mediterráneo S.A.", "PRODUCTOR", d13);
        cp6.setNima("2800000006"); cp6.setTelefono("965551234"); cp6.setEmail("medioambiente@jugmed.com"); cp6.setNombreContacto("Javier López");
        cp6 = centroRepository.save(cp6);

        Centro cp7 = new Centro(prod2, "Agroalimentaria Vega Baja", "PRODUCTOR", d11);
        cp7.setNima("2800000007"); cp7.setTelefono("966301234"); cp7.setEmail("residuos@agrovegabaja.com"); cp7.setNombreContacto("Miguel Torres");
        cp7 = centroRepository.save(cp7);

        Centro cg1 = new Centro(gestor1, "Planta Tratamiento Alicante", "GESTOR", d3);
        cg1.setNima("2800000010"); cg1.setTelefono("965301234"); cg1.setEmail("planta@gestorlevante.com"); cg1.setNombreContacto("Laura Martínez");
        cg1 = centroRepository.save(cg1);

        Centro cg2 = new Centro(gestor1, "Gestor Residuos Levante", "GESTOR", d9);
        cg2.setNima("2800000011"); cg2.setTelefono("965311234"); cg2.setEmail("info@gestorlevante.com"); cg2.setNombreContacto("Laura Martínez");
        cg2 = centroRepository.save(cg2);

        Centro cg3 = new Centro(gestor2, "Planta Reciclaje Murcia", "GESTOR", d10);
        cg3.setNima("2800000012"); cg3.setTelefono("968201234"); cg3.setEmail("planta@reciclajemurcia.com"); cg3.setNombreContacto("Carlos Ruiz");
        cg3 = centroRepository.save(cg3);

        Centro cg4 = new Centro(gestor2, "Reciclados Valencia Norte", "GESTOR", d12);
        cg4.setNima("2800000013"); cg4.setTelefono("961501234"); cg4.setEmail("info@recicladosvn.com"); cg4.setNombreContacto("Carlos Ruiz");
        cg4 = centroRepository.save(cg4);

        Centro cg5 = new Centro(gestor1, "Centro Logístico Torrellano", "GESTOR", d6);
        cg5.setNima("2800000014"); cg5.setTelefono("966321234"); cg5.setEmail("logistica@torrellano.com"); cg5.setNombreContacto("Laura Martínez");
        cg5 = centroRepository.save(cg5);

        Centro cg6 = new Centro(gestor2, "Puerto Deportivo Jávea", "GESTOR", d7);
        cg6.setNima("2800000015"); cg6.setTelefono("965791234"); cg6.setEmail("medio@puertojavea.com"); cg6.setNombreContacto("Carlos Ruiz");
        ...
        r1.setCodigoLER("200301"); r1.setDescripcion("Mezclas de residuos municipales"); r1.setFechaEntradaAlmacen(now.minusDays(200)); r1.setDiasMaximoAlmacenamiento(180);
        r1 = residuoRepository.save(r1);

        Residuo r2 = new Residuo(800.0, "kg", "ALMACENADO", cp1);
        r2.setCodigoLER("150101"); r2.setDescripcion("Envases de papel y cartón"); r2.setFechaEntradaAlmacen(now.minusDays(45)); r2.setDiasMaximoAlmacenamiento(180);
        r2 = residuoRepository.save(r2);

        Residuo r3 = new Residuo(350.0, "kg", "ALMACENADO", cp2);
        r3.setCodigoLER("040199"); r3.setDescripcion("Residuos industria del cuero"); r3.setFechaEntradaAlmacen(now.minusDays(190)); r3.setDiasMaximoAlmacenamiento(180);
        r3 = residuoRepository.save(r3);

        Residuo r4 = new Residuo(120.0, "litros", "ALMACENADO", cp2);
        r4.setCodigoLER("140603"); r4.setDescripcion("Disolventes y mezclas orgánicas"); r4.setFechaEntradaAlmacen(now.minusDays(30)); r4.setDiasMaximoAlmacenamiento(180);
        r4 = residuoRepository.save(r4);

        Residuo r5 = new Residuo(2000.0, "kg", "ALMACENADO", cp3);
        r5.setCodigoLER("040222"); r5.setDescripcion("Residuos de fibras textiles"); r5.setFechaEntradaAlmacen(now.minusDays(60)); r5.setDiasMaximoAlmacenamiento(180);
        r5 = residuoRepository.save(r5);

        Residuo r6 = new Residuo(450.0, "kg", "ALMACENADO", cp3);
        r6.setCodigoLER("150102"); r6.setDescripcion("Envases de plástico"); r6.setFechaEntradaAlmacen(now.minusDays(15)); r6.setDiasMaximoAlmacenamiento(180);
        r6 = residuoRepository.save(r6);

        Residuo r7 = new Residuo(600.0, "kg", "ALMACENADO", cp4);
        r7.setCodigoLER("020204"); r7.setDescripcion("Lodos del tratamiento de efluentes"); r7.setFechaEntradaAlmacen(now.minusDays(185)); r7.setDiasMaximoAlmacenamiento(180);
        r7 = residuoRepository.save(r7);

        Residuo r8 = new Residuo(250.0, "kg", "ALMACENADO", cp4);
        r8.setCodigoLER("150104"); r8.setDescripcion("Envases metálicos"); r8.setFechaEntradaAlmacen(now.minusDays(10)); r8.setDiasMaximoAlmacenamiento(180);
        r8 = residuoRepository.save(r8);

        Residuo r9 = new Residuo(80.0, "kg", "ALMACENADO", cp5);
        r9.setCodigoLER("180103"); r9.setDescripcion("Residuos sanitarios infecciosos"); r9.setFechaEntradaAlmacen(now.minusDays(5)); r9.setDiasMaximoAlmacenamiento(30);
        r9 = residuoRepository.save(r9);

        Residuo r10 = new Residuo(35.0, "kg", "ALMACENADO", cp5);
        r10.setCodigoLER("180106"); r10.setDescripcion("Productos químicos de laboratorio"); r10.setFechaEntradaAlmacen(now.minusDays(25)); r10.setDiasMaximoAlmacenamiento(90);
        r10 = residuoRepository.save(r10);

        Residuo r11 = new Residuo(1200.0, "kg", "ALMACENADO", cp6);
        r11.setCodigoLER("070213"); r11.setDescripcion("Residuos de plástico"); r11.setFechaEntradaAlmacen(now.minusDays(75)); r11.setDiasMaximoAlmacenamiento(180);
        r11 = residuoRepository.save(r11);

        Residuo r12 = new Residuo(90.0, "litros", "ALMACENADO", cp6);
        r12.setCodigoLER("080111"); r12.setDescripcion("Residuos de pintura y barniz"); r12.setFechaEntradaAlmacen(now.minusDays(40)); r12.setDiasMaximoAlmacenamiento(180);
        r12 = residuoRepository.save(r12);

        Residuo r13 = new Residuo(3000.0, "kg", "ALMACENADO", cp7);
        r13.setCodigoLER("020304"); r13.setDescripcion("Materias no aptas para consumo"); r13.setFechaEntradaAlmacen(now.minusDays(20)); r13.setDiasMaximoAlmacenamiento(90);
        r13 = residuoRepository.save(r13);

        Residuo r14 = new Residuo(500.0, "kg", "ALMACENADO", cp7);
        r14.setCodigoLER("150106"); r14.setDescripcion("Envases mezclados"); r14.setFechaEntradaAlmacen(now.minusDays(55)); r14.setDiasMaximoAlmacenamiento(180);
        r14 = residuoRepository.save(r14);

        Residuo r15 = new Residuo(700.0, "kg", "ALMACENADO", cp1);
        r15.setCodigoLER("200108"); r15.setDescripcion("Residuos biodegradables de cocina"); r15.setFechaEntradaAlmacen(now.minusDays(8)); r15.setDiasMaximoAlmacenamiento(30);
        r15 = residuoRepository.save(r15);

        Residuo r16 = new Residuo(160.0, "kg", "ALMACENADO", cp2);
        r16.setCodigoLER("120105"); r16.setDescripcion("Virutas y torneados plásticos"); r16.setFechaEntradaAlmacen(now.minusDays(100)); r16.setDiasMaximoAlmacenamiento(180);
        r16 = residuoRepository.save(r16);

        Residuo r17 = new Residuo(420.0, "kg", "ALMACENADO", cp3);
        r17.setCodigoLER("040209"); r17.setDescripcion("Residuos de materiales compuestos textiles"); r17.setFechaEntradaAlmacen(now.minusDays(130)); r17.setDiasMaximoAlmacenamiento(180);
        r17 = residuoRepository.save(r17);

        Residuo r18 = new Residuo(55.0, "litros", "ALMACENADO", cp5);
        r18.setCodigoLER("180102"); r18.setDescripcion("Restos anatómicos y órganos"); r18.setFechaEntradaAlmacen(now.minusDays(2)); r18.setDiasMaximoAlmacenamiento(7);
        r18 = residuoRepository.save(r18);

        Residuo r19 = new Residuo(1800.0, "kg", "ALMACENADO", cp6);
        r19.setCodigoLER("170201"); r19.setDescripcion("Madera de embalajes"); r19.setFechaEntradaAlmacen(now.minusDays(65)); r19.setDiasMaximoAlmacenamiento(180);
        r19 = residuoRepository.save(r19);

        Residuo r20 = new Residuo(300.0, "kg", "ALMACENADO", cp4);
        r20.setCodigoLER("020501"); r20.setDescripcion("Materias no aptas para consumo - lácteos"); r20.setFechaEntradaAlmacen(now.minusDays(12)); r20.setDiasMaximoAlmacenamiento(60);
        r20 = residuoRepository.save(r20);

        Residuo r21 = new Residuo(950.0, "kg", "ALMACENADO", cp7);
        r21.setCodigoLER("020106"); r21.setDescripcion("Heces, orina y estiércol animal"); r21.setFechaEntradaAlmacen(now.minusDays(35)); r21.setDiasMaximoAlmacenamiento(90);
        r21 = residuoRepository.save(r21);

        Residuo r22 = new Residuo(200.0, "kg", "ALMACENADO", cp1);
        r22.setCodigoLER("200121"); r22.setDescripcion("Tubos fluorescentes con mercurio"); r22.setFechaEntradaAlmacen(now.minusDays(192)); r22.setDiasMaximoAlmacenamiento(180);
        ...
        t1.setFechaProgramadaInicio(now.minusDays(60)); t1.setFechaProgramadaFin(now.minusDays(58));
        t1 = trasladoRepository.save(t1);

        Traslado t2 = new Traslado(cp2, cg2, r3, trans1);
        t2.setFechaProgramadaInicio(now.minusDays(50)); t2.setFechaProgramadaFin(now.minusDays(48));
        t2 = trasladoRepository.save(t2);

        Traslado t3 = new Traslado(cp3, cg1, r5, trans2);
        t3.setFechaProgramadaInicio(now.minusDays(30)); t3.setFechaProgramadaFin(now.minusDays(28));
        t3 = trasladoRepository.save(t3);

        Traslado t4 = new Traslado(cp4, cg3, r7, trans2);
        t4.setFechaProgramadaInicio(now.minusDays(2)); t4.setFechaProgramadaFin(now.plusDays(0));
        t4 = trasladoRepository.save(t4);

        Traslado t5 = new Traslado(cp5, cg2, r9, trans3);
        t5.setFechaProgramadaInicio(now.plusDays(3)); t5.setFechaProgramadaFin(now.plusDays(4));
        t5 = trasladoRepository.save(t5);

        Traslado t6 = new Traslado(cp6, cg4, r11, trans1);
        t6.setFechaProgramadaInicio(now.plusDays(5)); t6.setFechaProgramadaFin(now.plusDays(7));
        t6 = trasladoRepository.save(t6);

        Traslado t7 = new Traslado(cp7, cg3, r13, trans3);
        t7.setFechaProgramadaInicio(now.minusDays(40)); t7.setFechaProgramadaFin(now.minusDays(38));
        t7 = trasladoRepository.save(t7);

        Traslado t8 = new Traslado(cp1, cg2, r2, trans2);
        t8.setFechaProgramadaInicio(now.minusDays(20)); t8.setFechaProgramadaFin(now.minusDays(18));
        t8 = trasladoRepository.save(t8);

        Traslado t9 = new Traslado(cp2, cg1, r4, trans1);
        t9.setFechaProgramadaInicio(now.minusDays(1)); t9.setFechaProgramadaFin(now.plusDays(1));
        t9 = trasladoRepository.save(t9);

        Traslado t10 = new Traslado(cp3, cg4, r6, trans3);
        t10.setFechaProgramadaInicio(now.plusDays(10)); t10.setFechaProgramadaFin(now.plusDays(12));
        t10 = trasladoRepository.save(t10);

        Traslado t11 = new Traslado(cp4, cg1, r8, trans1);
        t11.setFechaProgramadaInicio(now.minusDays(70)); t11.setFechaProgramadaFin(now.minusDays(68));
        t11 = trasladoRepository.save(t11);

        Traslado t12 = new Traslado(cp6, cg2, r12, trans2);
        t12.setFechaProgramadaInicio(now.plusDays(7)); t12.setFechaProgramadaFin(now.plusDays(9));
        t12 = trasladoRepository.save(t12);

        Traslado t13 = new Traslado(cp7, cg4, r14, trans3);
        t13.setFechaProgramadaInicio(now.minusDays(80)); t13.setFechaProgramadaFin(now.minusDays(78));
        t13 = trasladoRepository.save(t13);

        Traslado t14 = new Traslado(cp5, cg3, r10, trans1);
        t14.setFechaProgramadaInicio(now.minusDays(15)); t14.setFechaProgramadaFin(now.minusDays(13));
        t14 = trasladoRepository.save(t14);

        Traslado t15 = new Traslado(cp1, cg4, r15, trans2);
        t15.setFechaProgramadaInicio(now.minusDays(1)); t15.setFechaProgramadaFin(now.plusDays(1));
        t15 = trasladoRepository.save(t15);

        Traslado t16 = new Traslado(cp6, cg1, r19, trans3);
        t16.setFechaProgramadaInicio(now.plusDays(14)); t16.setFechaProgramadaFin(now.plusDays(16));
        ...
        rec1.setResiduo(r16); rec1.setCentroOrigen(cp2); rec1.setCentroDestino(cg1);
        rec1.setTransportista(trans1); rec1.setFechaProgramada(today.plusDays(2)); rec1.setEstado(EstadoRecogida.PROGRAMADA);
        rec1.setObservaciones("Recoger virutas plásticas de fábrica");
        recogidaRepository.save(rec1);

        Recogida rec2 = new Recogida();
        rec2.setResiduo(r17); rec2.setCentroOrigen(cp3); rec2.setCentroDestino(cg2);
        rec2.setTransportista(trans2); rec2.setFechaProgramada(today.plusDays(1)); rec2.setEstado(EstadoRecogida.PROGRAMADA);
        rec2.setObservaciones("Material textil compuesto - frágil");
        recogidaRepository.save(rec2);

        Recogida rec3 = new Recogida();
        rec3.setResiduo(r18); rec3.setCentroOrigen(cp5); rec3.setCentroDestino(cg1);
        rec3.setTransportista(trans3); rec3.setFechaProgramada(today); rec3.setEstado(EstadoRecogida.EN_CURSO);
        rec3.setObservaciones("Residuo sanitario - transporte especial");
        recogidaRepository.save(rec3);

        Recogida rec4 = new Recogida();
        rec4.setResiduo(r20); rec4.setCentroOrigen(cp4); rec4.setCentroDestino(cg3);
        rec4.setTransportista(trans1); rec4.setFechaProgramada(today.minusDays(5)); rec4.setEstado(EstadoRecogida.COMPLETADA);
        rec4.setObservaciones("Recogida de lácteos caducados completada");
        recogidaRepository.save(rec4);

        Recogida rec5 = new Recogida();
        rec5.setResiduo(r21); rec5.setCentroOrigen(cp7); rec5.setCentroDestino(cg3);
        rec5.setTransportista(trans2); rec5.setFechaProgramada(today.minusDays(10)); rec5.setEstado(EstadoRecogida.COMPLETADA);
        rec5.setObservaciones("Estiércol animal recogido sin incidencias");
        recogidaRepository.save(rec5);

        Recogida rec6 = new Recogida();
        rec6.setResiduo(r22); rec6.setCentroOrigen(cp1); rec6.setCentroDestino(cg2);
        rec6.setTransportista(trans3); rec6.setFechaProgramada(today.plusDays(4)); rec6.setEstado(EstadoRecogida.PROGRAMADA);
        ...
        rec7.setResiduo(r19); rec7.setCentroOrigen(cp6); rec7.setCentroDestino(cg4);
        rec7.setTransportista(trans1); rec7.setFechaProgramada(today.minusDays(3)); rec7.setEstado(EstadoRecogida.EN_CURSO);
        rec7.setObservaciones("Madera de embalaje - gran volumen");
        recogidaRepository.save(rec7);

        Recogida rec8 = new Recogida();
        rec8.setResiduo(r6); rec8.setCentroOrigen(cp3); rec8.setCentroDestino(cg1);
        rec8.setTransportista(trans2); rec8.setFechaProgramada(today.plusDays(6)); rec8.setEstado(EstadoRecogida.PROGRAMADA);
        rec8.setObservaciones("Envases plásticos para reciclaje");
        recogidaRepository.save(rec8);

        Recogida rec9 = new Recogida();
        rec9.setResiduo(r8); rec9.setCentroOrigen(cp4); rec9.setCentroDestino(cg2);
        rec9.setTransportista(trans3); rec9.setFechaProgramada(today.minusDays(15)); rec9.setEstado(EstadoRecogida.CANCELADA);
        rec9.setObservaciones("Cancelada por cierre temporal del centro");
        recogidaRepository.save(rec9);

        Recogida rec10 = new Recogida();
        rec10.setResiduo(r4); rec10.setCentroOrigen(cp2); rec10.setCentroDestino(cg1);
        rec10.setTransportista(trans1); rec10.setFechaProgramada(today.minusDays(7)); rec10.setEstado(EstadoRecogida.COMPLETADA);
        rec10.setObservaciones("Disolventes recogidos con ADR");
        recogidaRepository.save(rec10);

        Recogida rec11 = new Recogida();
        rec11.setResiduo(r10); rec11.setCentroOrigen(cp5); rec11.setCentroDestino(cg3);
        rec11.setTransportista(trans2); rec11.setFechaProgramada(today.plusDays(8)); rec11.setEstado(EstadoRecogida.PROGRAMADA);
        rec11.setObservaciones("Productos químicos laboratorio");
        recogidaRepository.save(rec11);

        Recogida rec12 = new Recogida();
        rec12.setResiduo(r12); rec12.setCentroOrigen(cp6); rec12.setCentroDestino(cg4);
        rec12.setTransportista(trans3); rec12.setFechaProgramada(today.minusDays(1)); rec12.setEstado(EstadoRecogida.EN_CURSO);
        ...
        log.info("Seed completado: 10 usuarios, 16 direcciones, 13 centros, 1 empresa, 22 residuos, 16 traslados, 12 recogidas, 10 documentos, 6 rutas");
    }
