...
import com.alejandrofernandez.ecoadmin.dto.DocumentoDraftCreateDTO;
import com.alejandrofernandez.ecoadmin.dto.DocumentoWorkflowDTO;
...
public class DocumentoE2ETest {
    ...
    void testCrearYGenerarDI() throws Exception {
        ...
        MvcResult crearResult = mockMvc.perform(post("/api/documentos/drafts")
                ...
                .with(user("gestor@test.com").roles("GESTOR")))
    ...
    void testFlujoCompletoE2E() throws Exception {
        ...
        // 3. Descargar
        mockMvc.perform(get("/api/documentos/{id}/pdf", docId)
                .with(user("gestor@test.com").roles("GESTOR")))
                .andExpect(status().isOk())
