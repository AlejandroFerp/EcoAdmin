...
test.describe("Usuarios", () => {
  test(
    ...
    async ({ page }) => {
      ...
      await usuariosPage.loginAndGoto();
  ...
  test(
    ...
    async ({ page }) => {
      const usuariosPage = new UsuariosPage(page);
      await usuariosPage.loginAndGoto();
      await expect(usuariosPage.addButton).toBeVisible();
    }
  );
  ...
  test(
    ...
    async ({ page }) => {
      const usuariosPage = new UsuariosPage(page);
      await usuariosPage.loginAndGoto();
      await expect(usuariosPage.tablehead).toContainText("Nombre");
      await expect(usuariosPage.tablehead).toContainText("Email");
      await expect(usuariosPage.tablehead).toContainText("Rol");
    }
  );
